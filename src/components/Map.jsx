        ...
        <div
            className={cn(
                ...
                expanded
                    ...
                    : "max-h-[64px] md:max-h-[44px]"
            )}
        >
            {/* Header / Toggle */}
            <button
                onClick={onToggleExpand}
                className="w-full flex items-center justify-between px-4 pt-4 pb-10 md:py-2.5 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer select-none"
            >
